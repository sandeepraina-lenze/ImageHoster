...
public class ImageController {
    ...
    //The method returns to the 'images/edit.html' page if the user is the owner of the image
    //Else the method returns to the 'images/image.html' page with a message that only owner can edit the image
    ...
    //The method deletes the image and redirect to the 'images.html' page if the user is the owner of the image
    //Else the method returns to the 'images/image.html' page with a message that only owner can delete the image
